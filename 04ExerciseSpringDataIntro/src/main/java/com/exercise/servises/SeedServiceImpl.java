...
import com.exercise.enums.AgeRestriction;
import com.exercise.enums.EditionType;
...
public class SeedServiceImpl implements SeedService {
    private static final String RESOURCE_PATH = "src" + File.separator + "main" + File.separator + "resources" + File.separator + "files";
    private static final String AUTHORS_FILE_PATH = RESOURCE_PATH + File.separator + "authors.txt";
    private static final String CATEGORIES_FILE_PATH = RESOURCE_PATH + File.separator + "categories.txt";
    private static final String BOOKS_FILE_PATH = RESOURCE_PATH + File.separator + "books.txt";
